...
- `docs/HERWIKI_GITHUB_DISCOVERY_REPORT_FIRST_IMPLEMENTATION_PLAN.md`
  Execution-ready implementation plan for the deterministic GitHub discovery collector, report renderer, and cron wrapper.

- `docs/HERWIKI_GITHUB_DISCOVERY_REPORT_FIRST_TOOL.md`
  Operator and runtime usage guide for the deterministic GitHub discovery helper and wrapper.
